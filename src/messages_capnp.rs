...
pub mod command_response {
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn set_not_leader<'b>(&mut self, value : ::messages_capnp::not_leader::Reader<'b>) -> Result<()> {
      self.builder.set_data_field::<u16>(0, 2);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
    }
    #[inline]
    pub fn init_not_leader(self, ) -> ::messages_capnp::not_leader::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 2);
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), 0)
    }
    pub fn has_not_leader(&self) -> bool {
  ...
  pub type WhichReader<'a,> = Which<Result<data::Reader<'a>>,Result<::messages_capnp::not_leader::Reader<'a>>>;
  pub type WhichBuilder<'a,> = Which<Result<data::Builder<'a>>,Result<::messages_capnp::not_leader::Builder<'a>>>;
}
...
pub mod not_leader {
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn set_leader_id(&mut self, value : u64)  {
      self.builder.set_data_field::<u64>(0, value);
    }
  }
  ...
  mod _private {
    use capnp::private::layout;
    pub const STRUCT_SIZE : layout::StructSize = layout::StructSize { data : 1, pointers : 1 };
    pub const TYPE_ID: u64 = 0xf26c2e7054e6afbb;
  }
}
